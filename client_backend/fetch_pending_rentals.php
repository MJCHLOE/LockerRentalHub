...
try {
    $query = "SELECT r.rental_id, r.locker_id, r.rental_date, r.rental_status,
                     lu.price_per_month, ls.size_name
              FROM rental r
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><td colspan='6' class='text-center'>No pending rentals found</td></tr>";
    }
